...
De acuerdo con esto declaramos los metodos fuera de la clase pero en el modulo
*/
/* ***********************************
 * CONSTANTES
 * ***********************************/
$.yata = {
   ...
   ,panels: new Map()
   ,init: function() {
      alert("Entra en init de YATAApp");
   }
  ,test: function() {
    alert("YATAApp test");
  }
...
/*JGGBEG
 const toggleBtnLeft = "[data-toggle='yataoffcanvas']";

function _yataActivatePushMenu() {
alert("_yataActivatePushMenu");

                  //Enable sidebar toggle
                  $(document).on('click', toggleBtnLeft, function (e) {
alert("toggleBtnLeft Clickado");
                    e.preventDefault();
