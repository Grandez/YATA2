...
-- Subgrupo 1: Etiquetas de nombres de campos en posicion
...
-- Subgrupo 2: Etiquetas de nombres de campos en operacion
INSERT INTO PARAMETERS  (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 60,  2,  1,  1,  99, "id"           , "LBL.OPER_ID"            );
INSERT INTO PARAMETERS  (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 60,  2,  2,  1,  99, "type"         , "LBL.OPER_TYPE"          );
INSERT INTO PARAMETERS  (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 60,  2,  3,  1,  99, "camera"       , "LBL.OPER_CAMERA"        );
INSERT INTO PARAMETERS  (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 60,  2,  4,  1,  99, "base"         , "LBL.OPER_BASE"          );
INSERT INTO PARAMETERS  (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 60,  2,  5,  1,  99, "counter"      , "LBL.OPER_COUNTER"       );
INSERT INTO PARAMETERS  (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 60,  2,  6,  1,  99, "amount"       , "LBL.OPER_AMOUNT"        );
INSERT INTO PARAMETERS  (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 60,  2,  7,  1,  99, "value"        , "LBL.OPER_VALUE"         );
INSERT INTO PARAMETERS  (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 60,  2,  8,  1,  99, "price"        , "LBL.OPER_PRICE"         );
INSERT INTO PARAMETERS  (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 60,  2,  9,  1,  99, "active"       , "LBL.OPER_ACTIVE"        );
INSERT INTO PARAMETERS  (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 60,  2, 10,  1,  99, "status"       , "LBL.OPER_STATUS"        );
INSERT INTO PARAMETERS  (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 60,  2, 11,  1,  99, "parent"       , "LBL.OPER_PARENT"        );
INSERT INTO PARAMETERS  (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 60,  2, 12,  1,  99, "tms"          , "LBL.OPER_TMS"           );
INSERT INTO PARAMETERS  (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 60,  2, 13,  1,  99, "tmsLast"      , "LBL.OPER_TMS_LAST"      );
INSERT INTO PARAMETERS  (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 60,  2, 14,  1,  99, "fee"          , "LBL.OPER_FEE"           );
INSERT INTO PARAMETERS  (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 60,  2, 15,  1,  99, "gas"          , "LBL.OPER_GAS"           );
INSERT INTO PARAMETERS  (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 60,  2, 16,  1,  99, "limit"        , "LBL.OPER_LIMIT"         );
INSERT INTO PARAMETERS  (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 60,  2, 17,  1,  99, "stop"         , "LBL.OPER_STOP"          );
INSERT INTO PARAMETERS  (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 60,  2, 18,  1,  99, "target"       , "LBL.OPER_TARGET"        );
INSERT INTO PARAMETERS  (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 60,  2, 19,  1,  99, "deadline"     , "LBL.OPER_DEADLINE"      );
INSERT INTO PARAMETERS  (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 60,  2, 20,  1,  99, "amountIn"     , "LBL.OPER_AMOUNT_IN"     );
INSERT INTO PARAMETERS  (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 60,  2, 21,  1,  99, "priceIn"      , "LBL.OPER_PRICE_IN"      );
INSERT INTO PARAMETERS  (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 60,  2, 22,  1,  99, "amountOut"    , "LBL.OPER_AMOUNT_OUT"    );
INSERT INTO PARAMETERS  (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 60,  2, 23,  1,  99, "priceOut"     , "LBL.OPER_PRICE_OUT"     );
INSERT INTO PARAMETERS  (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 60,  2, 24,  1,  99, "expense"      , "LBL.OPER_EXPENSE"       );
INSERT INTO PARAMETERS  (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 60,  2, 25,  1,  99, "profit"       , "LBL.OPER_PROFIT"        );
INSERT INTO PARAMETERS  (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 60,  2, 26,  1,  99, "alive"        , "LBL.OPER_ALIVE"         );
INSERT INTO PARAMETERS  (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 60,  2, 27,  1,  99, "rank"         , "LBL.OPER_RANK"          );
INSERT INTO PARAMETERS  (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 60,  2, 28,  1,  99, "alert"        , "LBL.OPER_ALERT"         );
INSERT INTO PARAMETERS  (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 60,  2, 29,  1,  99, "dtAlert"      , "LBL.OPER_DT_ALERT"      );
INSERT INTO PARAMETERS  (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 60,  2, 30,  1,  99, "logType"      , "LBL.OPER_LOG_TYPE"      );
INSERT INTO PARAMETERS  (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 60,  2, 31,  1,  99, "reason"       , "LBL.OPER_REASON"        );
INSERT INTO PARAMETERS  (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 60,  2, 32,  1,  99, "comment"      , "LBL.OPER_COMMENT"       );
