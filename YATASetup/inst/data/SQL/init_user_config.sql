...
INSERT INTO  CONFIG   (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES (  1,   2,   2,   2,  20, 'autoOpen'       , '1');
...
-- 5 - Carteras
INSERT INTO  CONFIG   (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES (  5,   1,   1,   1,   1, 'id'             , 'Simm'                      );
INSERT INTO  CONFIG   (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES (  5,   1,   1,   2,   1, 'name'           , 'Cartera 1'                 );
INSERT INTO  CONFIG   (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES (  5,   1,   1,   3,   1, 'title'          , 'SHORT'                     );
...
INSERT INTO  CONFIG   (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES (  5,   1,   1,   8,   1, 'comment'        , 'Simulacion'                );
...
INSERT INTO  CONFIG   (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES (  5,   2,   2,   1,   1, 'id'             , 'Test'                      );
INSERT INTO  CONFIG   (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES (  5,   2,   2,   2,   1, 'name'           , 'Cartera 2'                 );
...
-- 10 - Databases                                                                                                                                       
INSERT INTO  CONFIG   (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 10,   1,   1,   1,   1, 'name'          , 'Simm'                       );
INSERT INTO  CONFIG   (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 10,   1,   1,   2,   1, 'descr'         , 'YATA Simulacion'            );
INSERT INTO  CONFIG   (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 10,   1,   1,   3,   1, 'engine'        , 'MariaDB'                    );
INSERT INTO  CONFIG   (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 10,   1,   1,   4,   1, 'dbname'        , 'YATA_Simm'                  );
...
INSERT INTO  CONFIG   (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 10,   2,   2,   1,   1, 'name'          , 'Test'                       );
INSERT INTO  CONFIG   (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 10,   2,   2,   2,   1, 'descr'         , 'YATA Test'                  );
INSERT INTO  CONFIG   (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 10,   2,   2,   3,   1, 'engine'        , 'MariaDB'                    );
INSERT INTO  CONFIG   (GRUPO, SUBGROUP, BLOCK, ID, TYPE, NAME, VALUE) VALUES ( 10,   2,   2,   4,   1, 'dbname'        , 'YATA_Test'                  );
