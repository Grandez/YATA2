...
formatPercentage = function(table, columns, digits = 3, interval = 3, mark = ',', dec.mark = getOption('OutDec')) {
...
formatRound = function(
  table, columns, digits = 3, interval = 3, mark = ',', dec.mark = getOption('OutDec')
) {
