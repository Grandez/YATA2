  ...
  main = tagList(
    ...
    ,fluidRow(
        ...
        ,yuiColumn(3
            ,fluidRow(h2("Control"))
            ,fluidRow(tags$table(
                 tags$tr(tags$td("Objetivo"),tags$td(yuiSwitch(ns("swTarget"),onLbl="%", offLbl="Value"))
                                            ,tags$td(yuiNumericInput(ns("target"), NULL, value = 5)))
                ,tags$tr(tags$td("Plazo"),   tags$td(colspan=2, yuiIntegerInput(ns("deadline"), NULL, value = 7)))
                ,tags$tr(tags$td("Stop"),    tags$td(yuiSwitch(ns("swStop"),onLbl="%", offLbl="Value"))
                ...
                ,tags$tr(tags$td("Revisar"), tags$td(colspan=2, yuiIntegerInput(ns("alert"), NULL, value = 3)))
            ))
        )
        ,yuiColumn(3
            , fluidRow(h2("Resumen"))
